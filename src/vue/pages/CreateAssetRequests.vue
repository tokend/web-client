...
export default {
  ...
  computed: {
    ...mapGetters({
      requests: vuexTypes.createAssetRequests,
    }),
  },
  ...
  methods: {
    ...mapMutations({
      setRequests: vuexTypes.SET_CREATE_ASSET_REQUESTS,
      concatRequests: vuexTypes.CONCAT_CREATE_ASSET_REQUESTS,
    }),

    ...mapActions({
      loadCreateAssetRequests: vuexTypes.LOAD_CREATE_ASSET_REQUESTS,
