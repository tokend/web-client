...
export default {
  ...
  computed: {
    idDocumentType: {
      get () { return this.getData('documents.idDocumentType') },
      set (v) { this.setData('documents.idDocumentType', v) },
    },

    idDocumentFace: {
      get () { return this.getData('documents.idDocumentFace') },
      set (v) { this.setData('documents.idDocumentFace', v) },
    },
    idDocumentBack: {
      get () { return this.getData('documents.idDocumentBack') },
      set (v) { this.setData('documents.idDocumentBack', v) },
    },
    needIdDocumentBack () {
