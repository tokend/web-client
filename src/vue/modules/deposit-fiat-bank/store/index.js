...
export const getters = {
  ...
  [types.depositableFiatAssets]: state => state.assets.filter(item => {
    return item.isDepositable && item.balance.id && item.isFiat
  }),
  [types.fees]: state => state.fees,
}

export const depositFiatBankModule = {
  name: 'deposit-fiat-bank',
  namespaced: true,
  state,
  getters,
  actions,
