<template>
  <tbody>
    <template v-if="totalFee.value > 0">
      <tr class="attributes-viewer__table-row">
        <td class="attributes-viewer__table-cell">
          {{ 'user-movements-history.source-fixed-fee-lbl' | globalize }}
        </td>
        <td class="attributes-viewer__table-cell">
      ...
      <tr class="attributes-viewer__table-row">
        <td class="attributes-viewer__table-cell">
          ...
          {{ 'user-movements-history.source-calculated-percent-fee-lbl' | globalize }}
        </td>
        <td class="attributes-viewer__table-cell">
      ...
      <tr class="attributes-viewer__table-row">
        <td class="attributes-viewer__table-cell">
          {{ 'user-movements-history.destination-fixed-fee-lbl' | globalize }}
        </td>
        <td class="attributes-viewer__table-cell">
      ...
      <tr class="attributes-viewer__table-row">
        <td class="attributes-viewer__table-cell">
          <!-- eslint-disable-next-line max-len -->
          {{ 'user-movements-history.destination-calculated-percent-fee-lbl' | globalize }}
        </td>
        <td class="attributes-viewer__table-cell">
      ...
      <tr class="attributes-viewer__table-row">
        <td class="attributes-viewer__table-cell">
          {{ 'user-movements-history.total-fee-lbl' | globalize }}
        </td>
        <td class="attributes-viewer__table-cell">
    ...
    <tr class="attributes-viewer__table-row">
      <td class="attributes-viewer__table-cell">
        <!-- eslint-disable-next-line max-len -->
        {{ 'user-movements-history.source-pays-for-destination-lbl' | globalize }}
      </td>
      <td class="attributes-viewer__table-cell">
    ...
    <tr class="attributes-viewer__table-row">
      <td class="attributes-viewer__table-cell">
        {{ 'user-movements-history.subject-lbl' | globalize }}
      </td>
      <td class="attributes-viewer__table-cell">
    ...
    <tr class="attributes-viewer__table-row">
      <td class="attributes-viewer__table-cell">
        {{ 'user-movements-history.payment-sender-lbl' | globalize }}
      </td>
      <td class="attributes-viewer__table-cell">
    ...
    <tr class="attributes-viewer__table-row">
      <td class="attributes-viewer__table-cell">
        {{ 'user-movements-history.payment-recipient-lbl' | globalize }}
      </td>
      <td class="attributes-viewer__table-cell">
