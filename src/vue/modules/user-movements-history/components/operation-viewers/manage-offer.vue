  ...
  <tbody>
    <tr class="attributes-viewer__table-row" v-if="operationDetails.offerId">
      <td class="attributes-viewer__table-cell">
        {{ 'user-movements-history.offer-id-lbl' | globalize }}
      </td>
      <td class="attributes-viewer__table-cell">
    ...
    <tr class="attributes-viewer__table-row">
      <td class="attributes-viewer__table-cell">
        {{ 'user-movements-history.offer-direction-lbl' | globalize }}
      </td>
      <td class="attributes-viewer__table-cell">
        <template v-if="operationDetails.isBuy">
          {{
            'user-movements-history.offer-buy-asset-msg' | globalize({
        ...
        <template v-else>
          {{
            'user-movements-history.offer-sell-asset-msg' | globalize({
              asset: operationDetails.baseAssetCode,
            })
          }}
        </template>
    ...
    <tr class="attributes-viewer__table-row">
      <td class="attributes-viewer__table-cell">
        {{ 'user-movements-history.order-book-id-lbl' | globalize }}
      </td>
      <td class="attributes-viewer__table-cell">
        <template v-if="operationDetails.isSecondaryMarket">
          {{ 'user-movements-history.secondary-market-msg' | globalize }}
        </template>
        <template v-else>
    ...
    <tr class="attributes-viewer__table-row">
      <td class="attributes-viewer__table-cell">
        {{ 'user-movements-history.base-amount-lbl' | globalize }}
      </td>
      <td class="attributes-viewer__table-cell">
    ...
    <tr class="attributes-viewer__table-row">
      <td class="attributes-viewer__table-cell">
        {{ 'user-movements-history.quote-amount-lbl' | globalize }}
      </td>
      <td class="attributes-viewer__table-cell">
    ...
    <tr class="attributes-viewer__table-row">
      <td class="attributes-viewer__table-cell">
        {{ 'user-movements-history.price-lbl' | globalize }}
      </td>
      <td class="attributes-viewer__table-cell">
        {{ price | formatMoney }}
      </td>
    ...
    <tr class="attributes-viewer__table-row">
      <td class="attributes-viewer__table-cell">
        {{ 'user-movements-history.offer-state-lbl' | globalize }}
      </td>
      <td class="attributes-viewer__table-cell">
        <template v-if="operationDetails.isDeleted">
          {{ 'user-movements-history.offer-deleted-msg' | globalize }}
        </template>
        <template v-else>
          {{ 'user-movements-history.offer-still-placed-msg' | globalize }}
        </template>
      </td>
    </tr>
  </tbody>
