  ...
  <tbody>
    <tr class="attributes-viewer__table-row">
      <td class="attributes-viewer__table-cell">
        {{ 'user-movements-history.sale-id-lbl' | globalize }}
      </td>
      <td class="attributes-viewer__table-cell">
    ...
    <tr class="attributes-viewer__table-row">
      <td class="attributes-viewer__table-cell">
        {{ 'user-movements-history.sale-state-lbl' | globalize }}
      </td>
      <td class="attributes-viewer__table-cell">
        <template v-if="operationDetails.isSaleClosed">
          {{ 'user-movements-history.sale-closed-msg' | globalize }}
        </template>
        <template v-else-if="operationDetails.isSaleCanceled">
          {{ 'user-movements-history.sale-canceled-msg' | globalize }}
        </template>
      </td>
    </tr>
  </tbody>
