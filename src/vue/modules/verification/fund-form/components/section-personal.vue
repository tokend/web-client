<template>
  <div class="verification-fund-form__section">
    <p class="verification-fund-form__section-label">
      {{ 'fund-form.personal-details-lbl' | globalize }}
    </p>
    ...
    <div class="app__form-row">
      <div class="app__form-field">
        <input-field
          ...
          name="verification-fund-first-name"
          :label="'fund-form.first-name-lbl' | globalize"
      ...
      <div class="app__form-field">
        <input-field
          ...
          name="verification-fund-last-name"
          :label="'fund-form.last-name-lbl' | globalize"
