<template>
  <div class="asset-card-viewer">
    <div class="asset-card-viewer__header">
      <skeleton-loader
        template="bigIcon"
      />
    </div>
    <div class="asset-card-viewer__info">
      <skeleton-loader
        class="asset-card-viewer__code"
        template="bigString"
      />
      <skeleton-loader
        class="asset-card-viewer__name"
        template="smallString"
      />
      <skeleton-loader
        class="asset-card-viewer__balance"
        template="smallString"
      />
    </div>
  </div>
...
.asset-card-viewer__logo {
  margin: 0 auto;
}

.asset-card-viewer__info {
  padding: 1.6rem 2rem;
  // wait for 10.0.2 stylelint version
  /* stylelint-disable function-calc-no-invalid */
