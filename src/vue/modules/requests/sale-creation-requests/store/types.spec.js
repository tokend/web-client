...
describe('sale creation requests module types unit tests', () => {
  ...
  it('every entity in module should be mentioned in vuex-types', () => {
    for (const key of getModuleKeys(saleCreationRequestsModule)) {
  ...
  it('every key described in vuex-types should be a real vuex-entity', () => {
    const moduleKeys = [
      ...getModuleKeys(saleCreationRequestsModule),
    ]
