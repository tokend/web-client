...
Все команды `docker-compose` нужно использовать из той папки, в которой вы запускали проект,
или же хотите запустить проект. а именно из той папки, где находится необходимый `docker-compose.yml` файл.
